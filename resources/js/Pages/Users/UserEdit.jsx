...
export default function UserEdit({ auth,user, countries }) {
    console.log(user);
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Users (Edit : <img className="inline w-10" src={`/images/users/${user.user_image}`} /> {user.first_name+' '+user.last_name} )</h2>}
        >
            <Head title="Users" />
